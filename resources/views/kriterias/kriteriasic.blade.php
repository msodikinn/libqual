		...
		<div class="row">
			...
			<div class="box box-primary" >
               <div class="box-header">
              		<h3 class="box-title">Evaluasi Information Control</h3>
            	</div>
				        <div class="box-body">
                  <!--  <div class="row"> -->
					...
					<div class="table-responsive col-sm-12">
						...
						<tbody class="table-hover">
							@foreach($kriteriasic as $category)
							<tr>
								<td>
						...
						{{ $kriteriasic->appends(compact('q'))->links() }}
																					 			<div class="col-md-8"><a href="/laravelku/public/kriterias-lp" class="btn btn-warning btn-sm">Simpan & Lanjutkan</a></div>
