		...
		<div class="row">
			...
			<div class="box box-primary" >
               <div class="box-header">
              		<h3 class="box-title">Evaluasi Library As Place</h3>
            	</div>
				        <div class="box-body">
                  <!--  <div class="row"> -->
					...
					<div class="table-responsive col-sm-12">
						...
						<tbody class="table-hover">
							@foreach($kriteriaslp as $category)
							<tr>
								<td>
						...
						{{ $kriteriaslp->appends(compact('q'))->links() }}
																					 			<div class="col-md-8"><a href="#" class="btn btn-warning btn-sm">Selesai</a></div>
